...
export const ogamiEn: OgamiCopy = {
  ...
  gallery: {
    ...
    slides: [
      { id: 'lagoon', src: '/sections/ogami/lagoon.jpg', caption: '+120,000 m² swimming lagoons at the heart of the community' },
      { id: 'render-1', src: '/sections/ogami/building-render-1.jpg', caption: 'Retail & cafés on the main plaza' },
      { id: 'render-2', src: '/sections/ogami/building-render-2.jpg', caption: 'G+2 penthouse buildings with cascading terraces' },
      { id: 'render-3', src: '/sections/ogami/building-render-3.jpg', caption: 'Private gardens & pools clustered per block' },
      { id: 'concept', src: '/sections/ogami/concept-collage.jpg', caption: 'Calm coastal living with a contemporary touch' },
      { id: 'interiors', src: '/sections/ogami/interiors.jpg', caption: 'Highly crafted interior palettes' },
      { id: 'materials', src: '/sections/ogami/materials.jpg', caption: 'Natural materials with imported finishes' },
    ],
  },
  lead: {
