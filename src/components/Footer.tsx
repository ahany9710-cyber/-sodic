          ...
          >
            ...
            <div className="space-y-3 text-right">
              <a
                ...
                className="flex items-center justify-end gap-3 text-gray-300 hover:text-white transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center justify-end gap-3 text-base text-gray-300 hover:text-white transition-colors"
              >
                واتساب
